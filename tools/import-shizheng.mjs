 ...
 *   - 月内 h2 分类（重要讲话/文件/事件/科技/纪念日）→ **标签**，分类只到两级
 *     「时政要点 / 2025年11月」（用户 2026-09-23：「分类太多了……到二级类就够了，剩下等点进去看左边的自由选择」），
 *     月份这一级就是考点清单页，年份也降到标签
...
for (const b of blocks) {
  ...
  const flush = () => {
    ...
    posts.push({
      ...
      categories: ['学习', '时政要点', month],
      tags: ['时政', `${y}年`, month, CAT_NAME[cat], STAR_TAG[stars] || `${stars}星`],
      description: firstSentence(body),
